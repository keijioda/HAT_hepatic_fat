...
* Descriptive statistics on `hff`, `FWHM`, `sn`:
  ...
  * The issue of S/N = -1 has been corrected -- see the email correspondence on 1/27/25
...
* Zoom meeting on 1/23/2025 (KL/GS/CH/KO)
  * ~~S/N = -1 indicates invalid values?~~ 
    ...
    * **[Updated]** The issue of S/N = -1 has been corrected -- see the email correspondence on 1/27/25
